    ...
    <div className="max-w-[800px] w-[20em] border border-black mx-auto bg-white-50 rounded-lg shadow-lg overflow-hidden my-3 p-3">
      ...
      <div className="items-center">
        ...
        <div className="flex-col space-y-2 mt-[2em]">
          <button className="w-full text-2xl border border-black bg-white text-black py-1 rounded-md shadow hover:bg-blue-500 hover:shadow-md transition-all duration-300 text-xm">
            <Link href="decoration/package">View Packages </Link>
          </button>
