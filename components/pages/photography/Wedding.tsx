...
import wed from "../../../public/photography/wedding.jpeg";
    ...
    <div className="max-w-[800px] w-[20em] border border-black mx-auto bg-white-50 rounded-lg shadow-lg overflow-hidden my-3 p-3">
      ...
      <div className="items-center">
        ...
        <div className="h-44 bg-white flex items-center justify-center  rounded-sm shadow-inner text-xs">
          <Image className="h-44 w-auto" src={wed} alt={""} />
        </div>
        ...
        <div className="flex-col mb-[0em] space-y-2 mt-[2em]">
          <button className="w-full border border-black  bg-white text-black py-1 text-2xl  rounded-md shadow hover:bg-blue-500 hover:shadow-md transition-all duration-300 text-xm">
