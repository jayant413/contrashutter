import prod from "../../../public/photography/product.jpeg";
  ...
  return (
    <div className="max-w-[800px] w-[20em] border border-black mx-auto bg-white-50 rounded-lg shadow-lg overflow-hidden my-3 p-3">
      ...
      <div className="items-center">
        ...
        <div className="h-44 bg-white flex items-center justify-center text-gray-600 rounded-sm shadow-inner text-xs">
          <Image className="h-44 w-auto" src={prod} alt={""} />
        </div>
        ...
        <div className="flex-col space-y-2 mt-[2em]">
          <button className="w-full border border-black bg-white text-black text-bold text-2xl py-1 rounded-md shadow hover:bg-blue-500 hover:shadow-md transition-all duration-300 text-xm">
            <Link href="photography/package">View Packages</Link>
          </button>
